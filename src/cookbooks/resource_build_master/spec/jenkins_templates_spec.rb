      ...
      <hudson>
        ...
        <clouds>
          <org.jenkinsci.plugins.nomad.NomadCloud plugin="nomad@0.4">
            ...
            <jenkinsUrl>http://active.build.service.{{ key "config/services/consul/domain" }}:8080/builds</jenkinsUrl>
            <slaveUrl>http://active.build.service.{{ key "config/services/consul/domain" }}:8080/builds/jnlpJars/slave.jar</slaveUrl>
            <nomad>
